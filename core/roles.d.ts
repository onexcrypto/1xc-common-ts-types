declare type UserProfileScope = "user:profile:read" | "user:profile:activate" | "user:profile:block" | "user:profile:update" | "user:profile:.*" | "user:rules:assign" | "user:subaccounts:create";
